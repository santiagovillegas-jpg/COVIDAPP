        ...
        <Card className="p-8">
          ...
          {nextAppt ? (
            <div className="bg-muted/50 rounded-2xl p-6 border">
              ...
              <p className="text-muted-foreground">Hora: {format(parseISO(nextAppt.appointmentDate), "HH:mm a")}</p>
              {nextAppt.therapistName && (
                <p className="text-muted-foreground text-sm mt-1">Doctor: <strong>{nextAppt.therapistName}</strong></p>
              )}
